...
NeuralNetworkRM1Dot1::~NeuralNetworkRM1Dot1() { delete m_pcRobotState; }
...
void NeuralNetworkRM1Dot1::ControlStep() {
    ...
    if (m_pcProximity != NULL) {
        ...
        CCI_EPuckProximitySensor::TReadings cProcessedProxiReadings =
            m_pcRobotState->GetProximityInput();
    ...
    if (m_pcGround != NULL) {
        ...
        CCI_EPuckGroundSensor::SReadings cProcessedGroundReadings =
            m_pcRobotState->GetGroundInput();
    ...
    if (m_pcRAB != NULL) {
        ...
        CCI_EPuckRangeAndBearingSensor::TPackets sLastPackets =
            m_pcRobotState->GetRangeAndBearingMessages();
