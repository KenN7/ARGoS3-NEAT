#include "NeuralNetworkRM2Dot3X.h"
...
NeuralNetworkRM2Dot3X::NeuralNetworkRM2Dot3X() {
    m_pcWheels = NULL;
    m_pcRABAct = NULL;
    m_pcProximity = NULL;
    m_pcLight = NULL;
...
void NeuralNetworkRM2Dot3X::Init(TConfigurationNode& t_node) {
...
void NeuralNetworkRM2Dot3X::ControlStep() {
   ...
   if(m_pcRAB != NULL) {
    ...
    //fill input 24->29 (excluded) for messaging rab inputs
    m_inputs[26] = 1 - (2 / (1 + exp(unNumberMessagingNeighbors3))); // Saturate at 5, and is in [0,1]
    // for(int i = 35; i < 39; i++) {
...
void NeuralNetworkRM2Dot3X::Reset() {
...
void NeuralNetworkRM2Dot3X::Destroy() {}

REGISTER_CONTROLLER(NeuralNetworkRM2Dot3X, "epuck_nn_controller")
