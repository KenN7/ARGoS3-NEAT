#include "NeuralNetworkRM2Dot2.h"
...
NeuralNetworkRM2Dot2::NeuralNetworkRM2Dot2() {
    m_pcWheels = NULL;
    m_pcRABAct = NULL;
    m_pcProximity = NULL;
    m_pcLight = NULL;
...
void NeuralNetworkRM2Dot2::Init(TConfigurationNode& t_node) {
...
void NeuralNetworkRM2Dot2::ControlStep() {
...
void NeuralNetworkRM2Dot2::Reset() {
...
void NeuralNetworkRM2Dot2::Destroy() {}

REGISTER_CONTROLLER(NeuralNetworkRM2Dot2, "epuck_nn_controller")
