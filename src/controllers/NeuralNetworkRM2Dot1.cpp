#include "NeuralNetworkRM2Dot1.h"
...
NeuralNetworkRM2Dot1::NeuralNetworkRM2Dot1() {
    m_pcWheels = NULL;
    m_pcRABAct = NULL;
    m_pcProximity = NULL;
    m_pcLight = NULL;
...
void NeuralNetworkRM2Dot1::Init(TConfigurationNode& t_node) {
...
void NeuralNetworkRM2Dot1::ControlStep() {
...
void NeuralNetworkRM2Dot1::Reset() {
...
void NeuralNetworkRM2Dot1::Destroy() {}

REGISTER_CONTROLLER(NeuralNetworkRM2Dot1, "epuck_nn_controller")
