...
class Species {
  ...
  public:
    ...
    // Change the fitness of all the organisms in the species to possibly depend slightly on the age
    // of the species and then divide it by the size of the species so that the organisms in the
    // species "share" the fitness
    void adjust_fitness();
    ...
    // Counts the number of offspring expected from all its members skim is for keeping track of
    // remaining
