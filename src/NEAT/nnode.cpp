...
const nodetype NNode::get_type() { return type; }
...
void NNode::flushback_check(std::vector<NNode*>& seenlist) {
    ...
    if (!(type == SENSOR)) {
        ...
        if (activation_count > 0) {
            std::cout << "ALERT: " << this << " has activation count " << activation_count
                      << std::endl;
        }
        ...
        if (last_activation > 0) {
            std::cout << "ALERT: " << this << " has last_activation  " << last_activation
                      << std::endl;
        }

        if (last_activation2 > 0) {
            std::cout << "ALERT: " << this << " has last_activation2  " << last_activation2
                      << std::endl;
        }
...
NNode* NNode::get_analogue() { return analogue; }
...
bool NNode::overridden() { return override; }
