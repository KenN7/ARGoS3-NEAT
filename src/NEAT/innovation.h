...
enum innovtype { NEWNODE = 0, NEWLINK = 1 };
...
class Innovation {
  ...
  public:
    ...
    double innovation_num2; // If this is a new node innovation, then there are 2 innovations
    ...
    double old_innov_num; // If a new node was created, this is the innovnum of the gene's link it
                          // is being stuck inside
